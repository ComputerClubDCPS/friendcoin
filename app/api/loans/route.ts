      ...
      try {
        ...
        if (loanError) {
          ...
          Sentry.captureException(loanError, {
            ...
            extra: { user_id: user.id, amount_friendcoins, amount_friendship_fractions }
          })
        ...
        if (balanceError) {
          ...
          Sentry.captureException(balanceError, {
            ...
            extra: { user_id: user.id, new_balance: { friendcoins: newFriendcoins, fractions: finalFractions } }
          })
        ...
        if (transactionError) {
          ...
          Sentry.captureException(transactionError, {
            ...
            extra: { user_id: user.id, loan_id: loan.id }
          })
        }
